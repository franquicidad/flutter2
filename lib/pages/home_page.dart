...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ButtomNav(items: [
        ButtonNavItem(iconPath: "assets/browser.svg", label: "Inicio"),
        ButtonNavItem(iconPath: "assets/calendario.svg", label: "Seguimientos"),
        ButtonNavItem(iconPath: "assets/person.svg", label: "Chat"),
        ButtonNavItem(iconPath: "assets/browser.svg", label: "Desarrollo Flutter"),
      ],
      ),
      body: SafeArea(
        bottom: true,
